...
CONTAINS
  ...
  SUBROUTINE CPGB(LG1,LX1,LGB,LXB,LGM,LXM,LG2, &
    ...
    IF(IRET.EQ.0) THEN
       ...
       IF(IRET.EQ.0) THEN
          ...
          JGDT=-9999
          UNPACK=.FALSE.
          CALL GETGB2I2(LG1,LX1,KR1,JDISC,JIDS,JPDTN,JPDT,JGDTN, &
               JGDT,UNPACK,IDXVER,KR1X,GFLD1,IRET)
    ...
    DO WHILE(IRET.EQ.0)
       IF(LAM.EQ.5) THEN
          ...
          UNPACK=.FALSE.
          KRM=0
          CALL GETGB2I2(LGM,LXM,KRM,JDISC,JIDS,JJPDTN,JJPDT, &
               JGDTN,JGDT,UNPACK,IDXVER,KRMX,GFLDM,IRET)
  ...
  SUBROUTINE CPGB1(LG1,LX1,M1, &
    ...
    UNPACK=.TRUE.
    IDXVER=2
    CALL GETGB2I2(LG1,LX1,KS1,JDISC,JIDS,JPDTN,JPDT,JGDTN, &
         JGDT,UNPACK,IDXVER,KR1,GFLD1,IRET)
    K1=GFLD1%NGRDPTS
    ...
    IF(IRET.EQ.0) THEN
       ...
       IF(JUV.LE.NUV.AND.NPARM.EQ.IUV(JUV)) THEN
          ...
          CALL GETGB2I2(LG1,LX1,KRV,GFLD1%DISCIPLINE,GFLD1%IDSECT, &
               GFLD1%IPDTNUM,GFLD1%IPDTMPL,GFLD1%IGDTNUM, &
               GFLD1%IGDTMPL,UNPACK,IDXVER,KRVX,GFLDV,IRET)
    ...
    IF(IRET.EQ.0) THEN
       ...
       IF(LAM.EQ.5.AND.IB1I.EQ.1) THEN
          ...
          IF(IRET.EQ.0.AND.KRV.GT.0) THEN
             ...
             CALL GETGB2I2(LGM,LXM,KRM,GFLDM%DISCIPLINE,GFLDM%IDSECT, &
                  GFLDM%IPDTNUM,GFLDM%IPDTMPL,GFLDM%IGDTNUM, &
                  GFLDM%IGDTMPL,UNPACK,IDXVER,KRMX,GFLDMV,IRET)
             !            CALL GETGBEM(LGM,LXM,MM,KRM,JPDS,JGDS,JENS, &
             !                        MBUF,CBUFM,NLENM,NNUMM,MNUMM, &
