#!/bin/sh
#                 Utility WGRIB2
#  This script uses to test the utility wgrib2 which compiled with new G2
#  library v3.1.0.  
#
...
#
#  Inventory GRIB2 file by using the WGRIB2
#

echo "Testing wgrib2"
set -x
$wgrib2 -s  $data/$file >   $output_g2/$file.grib2.idx
if [ $? -ne 0 ]; then err=1; fi
set +x
echo " "
if [ -s $output_g2/$file.grib2.idx ]; then echo "PASS"; else echo "FAIL!"; err=1; fi
ls -l $output_g2/$file.grib2.idx
echo
