...
../src/grbindex/grbindex ref_gdaswave.t00z.wcoast.0p16.f000.grib1 test_gdaswave.grbindex.grib1.idx

# Check against expected output. First 120 bytes contain differences,
# so ignore them.
cmp -i 120 test_gdaswave.grbindex.grib1.idx ref_gdaswave.grbindex.grib1.idx
