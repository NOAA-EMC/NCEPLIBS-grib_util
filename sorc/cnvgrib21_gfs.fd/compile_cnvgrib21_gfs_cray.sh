...
######################################################################
#
# This script uses to build cnvgrib21_gfs on CRAY (craype-sandybridge)
...
if  [ $machine_type = l -o $machine_type = s ] ; then # For CRAY
   ...
   echo "  "
   echo "  The cnvgrib21_gfs only builds on Luna/Surge machine. "
   echo "  "
   echo "  "
   echo "  "
   exit
...
#
# Checking for cnvgrib21_gfs source code directory
#
cd  $dir
export chkfile=$dir/cnvgrib21_gfs.f

if  [  ! -f $chkfile ] ; then
    echo " "
    echo " "
    echo " ##### cnvgrib21_gfs source code NOT found  #####"
    echo " "
    echo " Building executable cnvgrib21_gfs can not continue.  Aborted ! "
    echo " "
    echo " "
...
# Loading IOBUF
   ...
   module list 2>compile-cnvgrib21_gfs_intel_sandybridge.log
   module list
   echo " "
   echo " "
   ...
   make -f makefile_cray &>>compile-cnvgrib21_gfs_intel_sandybridge.log
   make -f makefile_cray clean &>>compile-cnvgrib21_gfs_intel_sandybridge.log
   mkdir -p ../../exec &>>compile-cnvgrib21_gfs_intel_sandybridge.log
   mv cnvgrib21_gfs ../../exec &>>compile-cnvgrib21_gfs_intel_sandybridge.log
   echo " "
   echo " "
   echo " "
