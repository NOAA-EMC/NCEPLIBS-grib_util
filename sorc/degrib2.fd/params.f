...
! Correction 9/24/2020 - For GRMR  to   GRLE in (2,179,0,1,32) 
      data paramlist(231) /gribparam(2,179,0,1,32,'GRLE')/
...
! Added 12/06/2010
       ...
       data paramlist(756) /gribparam(255,255,0,0,255,'MISSING')/
...
! Added 03/10/2020   changed local CH --> LCH
...
! Added 03/04/2020
       ...
       data paramlist(782) /gribparam(255,255,0,1,129,'EFRCWAT')/
       data paramlist(783) /gribparam(255,255,0,1,130,'EFRRAIN')/
       data paramlist(784) /gribparam(255,255,0,1,131,'EFRCICE')/
       data paramlist(785) /gribparam(255,255,0,1,132,'EFRSNOW')/
       data paramlist(786) /gribparam(255,255,0,1,133,'EFRGRL')/
       data paramlist(787) /gribparam(255,255,0,1,134,'EFRHAIL')/
       data paramlist(788) /gribparam(255,255,0,1,135,'EFRSLC')/
       data paramlist(789) /gribparam(255,255,0,1,136,'EFRSICEC')/
       data paramlist(790) /gribparam(255,255,0,1,137,'EFARRAIN')/
       data paramlist(791) /gribparam(255,255,0,1,138,'EFARCICE')/
       data paramlist(792) /gribparam(255,255,0,1,139,'EFARSNOW')/
       data paramlist(793) /gribparam(255,255,0,1,140,'EFARGRL')/
       data paramlist(794) /gribparam(255,255,0,1,141,'EFARHAIL')/
       data paramlist(795) /gribparam(255,255,0,1,142,'EFARSIC')/
       data paramlist(796) /gribparam(255,255,0,1,231,'PPINDX')/
       data paramlist(797) /gribparam(255,255,0,1,232,'PROBCIP')/
       data paramlist(798) /gribparam(255,255,0,1,233,'SNOWLR')/
       data paramlist(799) /gribparam(255,255,0,1,234,'PCPDUR')/
       data paramlist(800) /gribparam(255,255,0,1,235,'CLLMR')/
       data paramlist(801) /gribparam(255,255,0,2,231,'TPWDIR')/
       data paramlist(802) /gribparam(255,255,0,2,232,'TPWSPD')/
       data paramlist(803) /gribparam(255,255,0,2,36,'AFRWE')/
       data paramlist(804) /gribparam(255,255,0,3,20,'SDSGSO')/
       data paramlist(805) /gribparam(255,255,0,3,21,'AOSGSO')/
       data paramlist(806) /gribparam(255,255,0,3,22,'SSGSO')/
       data paramlist(807) /gribparam(255,255,0,3,23,'GWD')/
       data paramlist(808) /gribparam(255,255,0,3,24,'ASGSO')/
       data paramlist(809) /gribparam(255,255,0,3,25,'NLPRES')/
       data paramlist(810) /gribparam(255,255,0,3,26,'EXPRES')/
       data paramlist(811) /gribparam(255,255,0,3,27,'UMFLX')/
       data paramlist(812) /gribparam(255,255,0,3,28,'DMFLX')/
       data paramlist(813) /gribparam(255,255,0,3,29,'UDRATE')/
       data paramlist(814) /gribparam(255,255,0,3,30,'DDRATE')/
       data paramlist(815) /gribparam(255,255,0,3,31,'UCLSPRS')/
       data paramlist(816) /gribparam(255,255,0,4,50,'UVIUCS')/
       data paramlist(817) /gribparam(255,255,0,4,52,'DSWRFCS')/
       data paramlist(818) /gribparam(255,255,0,4,53,'USWRFCS')/
       data paramlist(819) /gribparam(255,255,0,5,5,'NLWRF')/
       data paramlist(820) /gribparam(255,255,0,5,6,'NLWRCS')/
       data paramlist(821) /gribparam(255,255,0,5,7,'BRTEMP')/
       data paramlist(822) /gribparam(255,255,0,5,8,'DLWRFCS')/
       data paramlist(823) /gribparam(255,255,0,6,34,'SLWTC')/
       data paramlist(824) /gribparam(255,255,0,6,35,'SSWTC')/
       data paramlist(825) /gribparam(255,255,0,6,36,'FSTRPC')/
       data paramlist(826) /gribparam(255,255,0,6,37,'FCONPC')/
       data paramlist(827) /gribparam(255,255,0,6,38,'MASSDCD')/
       data paramlist(828) /gribparam(255,255,0,6,39,'MASSDCI')/
       data paramlist(829) /gribparam(255,255,0,6,40,'MDCCWD')/
       data paramlist(830) /gribparam(255,255,0,6,47,'VFRCWD')/
       data paramlist(831) /gribparam(255,255,0,6,48,'VFRCICE')/
       data paramlist(832) /gribparam(255,255,0,6,49,'VFRCIW')/
       data paramlist(833) /gribparam(255,255,0,7,19,'CONAPES')/
       data paramlist(834) /gribparam(255,255,0,7,203,'DCAPE')/
       data paramlist(835) /gribparam(255,255,0,7,204,'EFHL')/
       data paramlist(836) /gribparam(255,255,0,7,205,'ESP')/
       data paramlist(837) /gribparam(255,255,0,7,206,'CANGLE')/
       data paramlist(838) /gribparam(255,255,0,7,206,'CANGLE')/
       data paramlist(839) /gribparam(255,255,0,15,9,'RFCD')/
       data paramlist(840) /gribparam(255,255,0,15,10,'RFCI')/
       data paramlist(841) /gribparam(255,255,0,15,11,'RFSNOW')/
       data paramlist(842) /gribparam(255,255,0,15,12,'RFRAIN')/
       data paramlist(843) /gribparam(255,255,0,15,13,'RFGRPL')/
       data paramlist(844) /gribparam(255,255,0,15,14,'RFHAIL')/
       data paramlist(845) /gribparam(255,255,0,15,15,'HSR')/
       data paramlist(846) /gribparam(255,255,0,15,16,'HSRHT')/
       data paramlist(847) /gribparam(255,255,0,17,1,'LTPINX')/
       data paramlist(848) /gribparam(255,255,0,17,2,'CDGDLTFD')/
       data paramlist(849) /gribparam(255,255,0,17,3,'CDCDLTFD')/
       data paramlist(850) /gribparam(255,255,0,17,4,'TLGTFD')/
       data paramlist(851) /gribparam(255,255,0,18,0,'ACCES')/
       data paramlist(852) /gribparam(255,255,0,18,1,'ACIOD')/
       data paramlist(853) /gribparam(255,255,0,18,2,'ACRADP')/
       data paramlist(854) /gribparam(255,255,0,19,28,'MWTURB')/
       data paramlist(855) /gribparam(255,255,0,19,29,'CATEDR')/
       data paramlist(856) /gribparam(255,255,0,19,30,'EDPARM')/
       data paramlist(857) /gribparam(255,255,0,19,31,'MXEDPRM')/
       data paramlist(858) /gribparam(255,255,0,19,32,'HIFREL')/
       data paramlist(859) /gribparam(255,255,0,19,33,'VISLFOG')/
       data paramlist(860) /gribparam(255,255,0,19,34,'VISIFOG')/
       data paramlist(861) /gribparam(255,255,0,19,35,'VISBSN')/
       data paramlist(862) /gribparam(255,255,0,19,36,'PSNOWS')/
       data paramlist(863) /gribparam(255,255,0,19,37,'ICESEV')/
       data paramlist(864) /gribparam(255,255,0,19,238,'ELLINX')/
       data paramlist(865) /gribparam(255,255,1,0,7,'DISRS')/
       data paramlist(866) /gribparam(255,255,1,0,8,'GWUPS')/
       data paramlist(867) /gribparam(255,255,1,0,9,'GWLOWS')/
       data paramlist(868) /gribparam(255,255,1,0,10,'SFLORC')/
       data paramlist(869) /gribparam(255,255,1,0,11,'RVERSW')/
       data paramlist(870) /gribparam(255,255,1,0,12,'FLDPSW')/
       data paramlist(871) /gribparam(255,255,1,0,13,'DEPWSS')/
       data paramlist(872) /gribparam(255,255,1,0,14,'UPAPCP')/
       data paramlist(873) /gribparam(255,255,1,0,15,'UPASM')/
       data paramlist(874) /gribparam(255,255,1,0,16,'PERRATE')/
       data paramlist(875) /gribparam(255,255,1,2,0,'WDPTHIL')/
       data paramlist(876) /gribparam(255,255,1,2,1,'WTMPIL')/
       data paramlist(877) /gribparam(255,255,1,2,2,'WFRACT')/
       data paramlist(878) /gribparam(255,255,1,2,3,'SEDTK')/
       data paramlist(879) /gribparam(255,255,1,2,4,'SEDTMP')/
       data paramlist(880) /gribparam(255,255,1,2,5,'ICTKIL')/
       data paramlist(881) /gribparam(255,255,1,2,6,'ICETIL')/
       data paramlist(882) /gribparam(255,255,1,2,7,'ICECIL')/
       data paramlist(883) /gribparam(255,255,1,2,8,'LANDIL')/
       data paramlist(884) /gribparam(255,255,1,2,9,'SFSAL')/
       data paramlist(885) /gribparam(255,255,1,2,10,'SFTMP')/
       data paramlist(886) /gribparam(255,255,1,2,11,'ACWSR')/
       data paramlist(887) /gribparam(255,255,1,2,12,'SALTIL')/
       data paramlist(888) /gribparam(255,255,1,2,13,'CSAFC')/
       data paramlist(889) /gribparam(255,255,2,0,35,'TCLASS')/
       data paramlist(890) /gribparam(255,255,2,0,36,'TFRCT')/
       data paramlist(891) /gribparam(255,255,2,0,37,'TPERCT')/
       data paramlist(892) /gribparam(255,255,2,0,38,'SOILVIC')/
       data paramlist(893) /gribparam(255,255,2,0,39,'EVAPTRAT')/
       data paramlist(894) /gribparam(255,255,2,1,192,'CANL')/
       data paramlist(895) /gribparam(255,255,2,3,18,'SOILTMP')/
       data paramlist(896) /gribparam(255,255,2,3,19,'SOILMOI')/
       data paramlist(897) /gribparam(255,255,2,3,20,'CISOILM')/
       ...
       data paramlist(908) /gribparam(255,255,2,4,4,'FOSINDX')/
       data paramlist(909) /gribparam(255,255,2,4,5,'FWINX')/
       data paramlist(910) /gribparam(255,255,2,4,6,'FFMCODE')/
       data paramlist(911) /gribparam(255,255,2,4,7,'DUFMCODE')/
       data paramlist(912) /gribparam(255,255,2,4,8,'DRTCODE')/
       data paramlist(913) /gribparam(255,255,2,4,9,'INFSINX')/
       data paramlist(914) /gribparam(255,255,2,4,10,'FBUPINX')/
       data paramlist(915) /gribparam(255,255,2,4,11,'FDSRTE')/
       data paramlist(916) /gribparam(255,255,2,5,1,'GLACTMP')/
       data paramlist(917) /gribparam(255,255,3,0,0,'SRAD')/
       data paramlist(918) /gribparam(255,255,3,0,1,'SALBEDO')/
       data paramlist(919) /gribparam(255,255,3,0,2,'SBTMP')/
       data paramlist(920) /gribparam(255,255,3,0,3,'SPWAT')/
       data paramlist(921) /gribparam(255,255,3,0,4,'SLFTI')/
       data paramlist(922) /gribparam(255,255,3,0,5,'SCTPRES')/
       data paramlist(923) /gribparam(255,255,3,0,6,'SSTMP')/
       data paramlist(924) /gribparam(255,255,3,0,7,'CLOUDM')/
       data paramlist(925) /gribparam(255,255,3,0,8,'PIXST')/
       data paramlist(926) /gribparam(255,255,3,0,9,'FIREDI')/
       data paramlist(927) /gribparam(255,255,3,1,194,'SWQI')/
       data paramlist(928) /gribparam(255,255,3,2,0,'CSKPROB')/
       data paramlist(929) /gribparam(255,255,3,192,53,'SBTAGR8')/
       data paramlist(930) /gribparam(255,255,3,192,54,'SBTAGR9')/
       data paramlist(931) /gribparam(255,255,3,192,55,'SBTAGR10')/
       data paramlist(932) /gribparam(255,255,3,192,56,'SBTAGR11')/
       data paramlist(933) /gribparam(255,255,3,192,57,'SBTAGR12')/
       data paramlist(934) /gribparam(255,255,3,192,58,'SBTAGR13')/
       data paramlist(935) /gribparam(255,255,3,192,59,'SBTAGR14')/
       data paramlist(936) /gribparam(255,255,3,192,60,'SBTAGR15')/
       data paramlist(937) /gribparam(255,255,3,192,61,'SBTAGR16')/
       data paramlist(938) /gribparam(255,255,10,0,14,'WWSDIR')/
       data paramlist(939) /gribparam(255,255,10,0,15,'MWSPER')/
       data paramlist(940) /gribparam(255,255,10,0,16,'CDWW')/
       data paramlist(941) /gribparam(255,255,10,0,17,'FRICV')/
       data paramlist(942) /gribparam(255,255,10,0,18,'WSTR')/
       data paramlist(943) /gribparam(255,255,10,0,19,'NWSTR')/
       data paramlist(944) /gribparam(255,255,10,0,20,'MSSW')/
       data paramlist(945) /gribparam(255,255,10,0,21,'USSD')/
       data paramlist(946) /gribparam(255,255,10,0,22,'VSSD')/
       data paramlist(947) /gribparam(255,255,10,0,23,'PMAXWH')/
       data paramlist(948) /gribparam(255,255,10,0,24,'MAXWH')/
       data paramlist(949) /gribparam(255,255,10,0,25,'IMWF')/
       data paramlist(950) /gribparam(255,255,10,0,26,'IMFWW')/
       data paramlist(951) /gribparam(255,255,10,0,27,'IMFTSW')/
       data paramlist(952) /gribparam(255,255,10,0,28,'MZWPER')/
       data paramlist(953) /gribparam(255,255,10,0,29,'MZPWW')/
       data paramlist(954) /gribparam(255,255,10,0,30,'MZPTSW')/
       data paramlist(955) /gribparam(255,255,10,0,31,'WDIRW')/
       data paramlist(956) /gribparam(255,255,10,0,32,'DIRWWW')/
       data paramlist(957) /gribparam(255,255,10,0,33,'DIRWTS')/
       data paramlist(958) /gribparam(255,255,10,0,34,'PWPER')/
       data paramlist(959) /gribparam(255,255,10,0,35,'PPERWW')/
       data paramlist(960) /gribparam(255,255,10,0,36,'PPERTS')/
       data paramlist(961) /gribparam(255,255,10,0,37,'ALTWH')/
       data paramlist(962) /gribparam(255,255,10,0,38,'ALCWH')/
       data paramlist(963) /gribparam(255,255,10,0,39,'ALRRC')/
       data paramlist(964) /gribparam(255,255,10,0,40,'MNWSOW')/
       data paramlist(965) /gribparam(255,255,10,0,41,'MWDIRW')/
       data paramlist(966) /gribparam(255,255,10,0,42,'WESP')/
       data paramlist(967) /gribparam(255,255,10,0,43,'KSSEW')/
       data paramlist(968) /gribparam(255,255,10,0,44,'BENINX')/
       data paramlist(969) /gribparam(255,255,10,0,45,'SPFTR')/
       data paramlist(970) /gribparam(255,255,10,0,46,'PWAVEDIR')/
       data paramlist(971) /gribparam(255,255,10,0,47,'SWHFSWEL')/
       data paramlist(972) /gribparam(255,255,10,0,48,'SWHSSWEL')/
       data paramlist(973) /gribparam(255,255,10,0,49,'SWHTSWEL')/
       data paramlist(974) /gribparam(255,255,10,0,50,'MWPFSWEL')/
       data paramlist(975) /gribparam(255,255,10,0,51,'MWPSSWEL')/
       data paramlist(976) /gribparam(255,255,10,0,52,'MWPTSWEL')/
       data paramlist(977) /gribparam(255,255,10,0,53,'MWDFSWEL')/
       data paramlist(978) /gribparam(255,255,10,0,54,'MWDSSWEL')/
       data paramlist(979) /gribparam(255,255,10,0,55,'MWDTSWEL')/
       data paramlist(980) /gribparam(255,255,10,0,56,'WDWFSWEL')/
       data paramlist(981) /gribparam(255,255,10,0,57,'WDWSSWEL')/
       data paramlist(982) /gribparam(255,255,10,0,58,'WDWTSWEL')/
       data paramlist(983) /gribparam(255,255,10,0,59,'WFWFSWEL')/
       data paramlist(984) /gribparam(255,255,10,0,60,'WFWSSWEL')/
       data paramlist(985) /gribparam(255,255,10,0,61,'WFWTSWEL')/
       data paramlist(986) /gribparam(255,255,10,0,62,'WAVEFREW')/
       data paramlist(987) /gribparam(255,255,10,0,63,'FREWWW')/
       data paramlist(988) /gribparam(255,255,10,0,64,'FREWTSW')/
       data paramlist(989) /gribparam(255,255,10,1,4,'RIPCOP')/
       data paramlist(990) /gribparam(255,255,10,2,9,'ICEPRS')/
       data paramlist(991) /gribparam(255,255,10,2,10,'ZVCICEP')/
       data paramlist(992) /gribparam(255,255,10,2,11,'MVCICEP')/
       data paramlist(993) /gribparam(255,255,10,2,12,'CICES')/
       data paramlist(994) /gribparam(255,255,10,3,2,'CH')/
       data paramlist(995) /gribparam(255,255,10,3,3,'PRACTSAL')/
       data paramlist(996) /gribparam(255,255,10,3,204,'FRZSPR')/
       data paramlist(997) /gribparam(255,255,10,4,13,'ACWSRD')/
       data paramlist(998) /gribparam(255,255,10,3,205,'TWLWAV')/
       ...
       data paramlist(1006) /gribparam(255,255,10,3,252,'EROSNP')/
       data paramlist(1007) /gribparam(255,255,10,3,253,'OWASHP')/
       data paramlist(1008) /gribparam(255,255,10,4,14,'WDEPTH')/
       data paramlist(1009) /gribparam(255,255,10,4,15,'WTMPSS')/
       data paramlist(1010) /gribparam(255,255,10,4,16,'WATERDEN')/
       data paramlist(1011) /gribparam(255,255,10,4,17,'WATDENA')/
       data paramlist(1012) /gribparam(255,255,10,4,18,'WATPTEMP')/
