...
//fprintf(stderr,">> fill in pdt n=%d\n", n);
    ...
    if (pdt == 0) f_set_pdt(call_ARG1(inv_out, NULL, "+8"));
    else if (pdt == 5) f_set_pdt(call_ARG1(inv_out, NULL, "+9"));
    else if (pdt == 6) f_set_pdt(call_ARG1(inv_out, NULL, "+10"));
    else if (pdt == 1) f_set_pdt(call_ARG1(inv_out, NULL, "+11"));
    else if (pdt == 2) f_set_pdt(call_ARG1(inv_out, NULL, "+12"));
    else if (pdt == 3) f_set_pdt(call_ARG1(inv_out, NULL, "+13"));
    else if (pdt == 4) f_set_pdt(call_ARG1(inv_out, NULL, "+14"));
    else if (pdt == 33) f_set_pdt(call_ARG1(inv_out, NULL, "+34"));
    else if (pdt == 40) f_set_pdt(call_ARG1(inv_out, NULL, "+42"));
    else if (pdt == 41) f_set_pdt(call_ARG1(inv_out, NULL, "+43"));
    else if (pdt == 44) f_set_pdt(call_ARG1(inv_out, NULL, "+45"));
    else if (pdt == 48) f_set_pdt(call_ARG1(inv_out, NULL, "+46"));
    else if (pdt == 60) f_set_pdt(call_ARG1(inv_out, NULL, "+61"));
