     ...
     DO K=1,KM
       DO N=1,NO
         IF(N11(N).GT.0) THEN
           IF(IBI(K).EQ.0) THEN
!cdz+8
             IF(UI(N11(N),K) == FILL9 .OR. VI(N11(N),K) == FILL9 .OR. &
                UI(N21(N),K) == FILL9 .OR. VI(N21(N),K) == FILL9 .OR. &
                UI(N12(N),K) == FILL9 .OR. VI(N12(N),K) == FILL9 .OR. &
                UI(N22(N),K) == FILL9 .OR. VI(N22(N),K) == FILL9) THEN
                UO(N,K)=FILL9
                VO(N,K)=FILL9
                LO(N,K)=.FALSE.
             ELSE
...
!cdz+1
           ...
           ELSE
             IF(LI(N11(N),K)) THEN
!cdz+5
               IF(UI(N11(N),K) == FILL9 .OR. VI(N11(N),K) == FILL9) THEN
                  UO(N,K)=FILL9
                  VO(N,K)=FILL9
                  LO(N,K)=.FALSE.
               ELSE
...
!cdz+1
             ...
             IF(LI(N21(N),K)) THEN
!cdz+5
               IF(UI(N21(N),K) == FILL9 .OR. VI(N21(N),K) == FILL9) THEN
                  UO(N,K)=FILL9
                  VO(N,K)=FILL9
                  LO(N,K)=.FALSE.
               ELSE
...
!cdz+1
             ...
             IF(LI(N12(N),K)) THEN
!cdz+5
               IF(UI(N12(N),K) == FILL9 .OR. VI(N12(N),K) == FILL9) THEN
                  UO(N,K)=FILL9
                  VO(N,K)=FILL9
                  LO(N,K)=.FALSE.
               ELSE
...
!cdz+1
             ...
             IF(LI(N22(N),K)) THEN
!cdz+5
               IF(UI(N22(N),K) == FILL9 .OR. VI(N22(N),K) == FILL9) THEN
                  UO(N,K)=FILL9
                  VO(N,K)=FILL9
                  LO(N,K)=.FALSE.
               ELSE
